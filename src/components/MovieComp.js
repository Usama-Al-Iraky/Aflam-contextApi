...
const MovieComp = () => {
  const [urlData, , , , , , , lang] = useContext(ContextApi);
    ...
    <>
      <Row className="card-body mt-3 p-2 rounded">
        <Col xs="12" sm="6" md="6" lg="3">
          <Image
            src={urlData.imgUrl + movieDetails.poster_path}
            className="card-img d-block m-auto rounded"
          />
        </Col>
        <Col
          xs="12"
      ...
      <Row className="mt-3">
        <Col className="d-flex justify-content-center">
          <a href={movieDetails.homepage} target="_blanck">
